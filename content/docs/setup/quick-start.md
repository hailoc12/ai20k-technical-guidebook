...
```bash
git clone https://github.com/AI20K-Build-Cohort-2/starter-code-template.git A20-App-XXX
cd A20-App-XXX
```
...
git remote set-url origin https://github.com/YOUR_GITHUB_USERNAME/A20-App-XXX.git
